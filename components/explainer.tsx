...
import HowWork from '@/public/images/howWork.png'
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            <h2 className="h2 font-cabinet-grotesk">How It Works</h2>
            <p className="text-xl text-gray-600 mt-4">From setup to launch in just a few clicks.</p>
          </div>
          ...
          <div className="relative pb-12">
            ...
            <div className="max-w-sm mx-auto grid gap-12 sm:grid-cols-2 sm:max-w-3xl lg:grid-cols-4 lg:max-w-none items-start">
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">Connect Store</h3>
                <div className="text-gray-500">Link your Shopify or Ustore in seconds.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">Design App</h3>
                <div className="text-gray-500">Customize with our drag-and-drop builder.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">Preview Live</h3>
                <div className="text-gray-500">Test changes instantly on any device.</div>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="font-cabinet-grotesk font-bold text-lg">Go Publish</h3>
                <div className="text-gray-500">Launch on App Store & Google Play with ease.</div>
              </div>
            </div>
          </div>
